...
void Model::computeOutputSoftmax(Vector& hidden, Vector& output) const {
  ...
  /*
    ...
    This purpose is to avoid overflow about denominator.
...
/*
  ...
  Instruction
  ------------------------
  The way of calculation is same as cbow.
...
/*
  ...
  Instruction
  ----------------------------
  initSigmoid --> x in [- MAX_SIGMOID, + MAX_SIGMOID]
  there are SIGMOID_TABLE_SIZE samples in this range.
...
/*
  ...
  -------------------------------
  initLog --> x in (0, 1]
  There are LOG_TABLE_SIZE samples in this range.
